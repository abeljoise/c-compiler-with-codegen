...
#define SYMBOL_TABLE_SLOTS 20 // Default symbol table size; caller may initialize a different slot count.

typedef char* Scope; // Scope identifier represented as a string.

typedef struct SymbolEntry SymbolEntry;
typedef struct SymbolTable SymbolTable;

/*
The global symbol table stores global variables, type definitions, and function names.
Function entries point to nested symbol tables that store function-local symbols.
*/
